...
Then define the endogenous part of
the state:
...
where :math:`Q^c = \begin{bmatrix} 1 & -1 \\ -1 & 1 \end{bmatrix}`

Therefore, the overall :math:`Q` matrix for the Markov jump LQ problem is:
